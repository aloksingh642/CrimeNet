...
def startup_event():
    ...
    try:
        ...
        if existing == 0:
            ...
            demo_users = [
                {"username": "admin", "password": "admin123", "email": "admin@crimenet.demo", "full_name": "System Administrator", "role": "ADMIN"},
                {"username": "investigator", "password": "invest123", "email": "investigator@crimenet.demo", "full_name": "Senior Investigator", "role": "INVESTIGATOR"},
                {"username": "analyst", "password": "analyst123", "email": "analyst@crimenet.demo", "full_name": "Intelligence Analyst", "role": "ANALYST"},
            ]
            for u in demo_users:
